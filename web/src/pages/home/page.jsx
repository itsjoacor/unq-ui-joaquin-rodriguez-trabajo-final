...
function GamePlaySetUp() {
	...
	const handleStart = () => {
		navigate("/game", { state: { size: selectedSize } });
	};
	...
	return (
		<div className="flex items-center justify-center h-screen w-screen text-white">
			<div className="bg-black rounded-lg shadow-lg p-10 w-[90%] max-w-md flex flex-col items-center justify-center">
				<h1 className="text-4xl font-bold mb-8 text-center">Memo Test</h1>
				...
				<button
					onClick={handleStart}
					className="px-6 py-3 bg-green-500 text-white text-lg font-bold rounded hover:bg-green-600 w-full"
				>
					Start
				</button>
			</div>
